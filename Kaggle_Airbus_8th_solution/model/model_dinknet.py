...
class DinkNet34(nn.Module):
    def __init__(self, num_classes, num_filters = 64):
        ...
        self.decoder4 = DecoderBlock(num_filters*8, num_filters*4)
        self.decoder3 = DecoderBlock(num_filters*4, num_filters*2)
        self.decoder2 = DecoderBlock(num_filters*2, num_filters)
        self.decoder1 = DecoderBlock(num_filters, num_filters)

        self.finaldeconv1 = nn.ConvTranspose2d(num_filters, 32, 4, 2, 1)
        self.finalrelu1 = nonlinearity
        self.finalconv2 = nn.Conv2d(32, 32, 3, padding=1)
        self.finalrelu2 = nonlinearity
        self.finalconv3 = nn.Conv2d(32, num_classes, 3, padding=1)
