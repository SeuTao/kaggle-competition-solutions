...
def resnet50_ibn_a(pretrained=False, **kwargs):
    ...
    if pretrained:
        state_dict = torch.load(r'/data/shentao/Airbus/code/pretrained_model/resnet50_ibn_a.pth.tar')['state_dict']
...
def resnet101_ibn_a(pretrained=False, **kwargs):
    ...
    if pretrained:
        state_dict = torch.load(r'/data/shentao/Airbus/code/pretrained_model/resnet101_ibn_a.pth.tar')['state_dict']
        state_dict = state_dict_remove_moudle(state_dict, model)
        model.load_state_dict(state_dict)
...
#     loaded = torch.load(r'/data2/shentao/Projects/Kaggle_airbus/pretrained_model/resnet50_ibn_a.pth.tar')['state_dict']
#     # a = 0
