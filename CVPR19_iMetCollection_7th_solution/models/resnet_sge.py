...
def sge_resnet50(pretrained=True, **kwargs):
    ...
    if pretrained:
        print('sge_resnet50')
        pretrained_dict = torch.load(r'/home/shentao/sge_resnet50.pth.tar')
...
def sge_resnet101(pretrained=True, **kwargs):
    ...
    if pretrained:
        print('sge_resnet101')
        pretrained_dict = torch.load(r'/home/shentao/sge_resnet101.pth.tar')
        model_dict = model.state_dict()
        pretrained_dict = {k: v for k, v in pretrained_dict.items() if k in model_dict and 'fc' not in k}
        model_dict.update(pretrained_dict)
        model.load_state_dict(model_dict)
