...
def OctResnet50(num_classes=1000, pretrained='imagenet'):
    model = OctResNet(Bottleneck, [3, 4, 6, 3],num_classes=num_classes)

    if pretrained:
        print('load OctResnet50')
        pretrained_dict = torch.load(r'/data/oct_resnet50_cosine.pth')
