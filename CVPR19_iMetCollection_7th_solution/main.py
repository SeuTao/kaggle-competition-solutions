...
def main():
    ...
    arg('--run_root', default='result/enet_B3_336_ratio_0.6_0.99_re_fold4')
    arg('--fold', type=int, default=4)
    arg('--model', default='enet_B3')
    ...
    model = getattr(models, args.model)(num_classes=N_CLASSES, pretrained='imagenet')
